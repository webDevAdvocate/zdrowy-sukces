import classes from './termsSection.module.scss';

export const TermsSection = () => {
    return <section className={classes.section}>
        <h1>Regulamin</h1>
        <h3>
            Strony internetowej <a className={classes.contrast} href=">www.zdrowy-sukces.pl">
        ...
        <ol>
            ...
            <li>Sklep – sklep internetowy działający pod adresem www.zdrowy-sukces.pl</li>
        ...
        <ol>
            <li>Za pośrednictwem Sklepu, Dietetyk zapewnia Klientowi możliwość zawarcia umowy o dostarczenie treści cyfrowych, świadczenia usług z zakresy planowania żywieniowego oraz suplementacji, współpracy online, a także innych produktów opisanych na stronach Sklepu.</li>
        ...
        <h4>§3</h4>
        <h4>Usługi świadczone drogą elektroniczną</h4>
        <ol>
            <li>Za pośrednictwem Sklepu, Dietetyk świadczy na rzecz Klienta usługi drogą elektroniczną.</li>
            <li>Podstawową usługą świadczoną drogą elektroniczną na rzecz Klienta przez Dietetyka jest umożliwienie Klientowi złożenia zamówienia w Sklepie prowadzącego do zawarcia z Dietetykiem umowy.</li>
            <li>Podstawową usługą świadczoną drogą elektroniczną na rzecz Klienta przez Dietetyka jest umożliwienie Klientowi złożenia zamówienia w Sklepie prowadzącego do zawarcia z Dietetykiem umowy.</li>
        ...
        <ol>
            ...
            <li>Po kliknięciu w przycisk finalizujący zamówienie Klient zostanie przekierowany do bramki płatności, zgodnie z wybraną metodą płatności na stronie www.1koszyk.pl. Po skutecznym dokonaniu płatności, Klient zostanie zwrotnie przekierowany na stronę Sklepu z potwierdzeniem zamówienia. Z tą chwilą umowę uważa się za zawartą pomiędzy Klientem a Dietetykiem. Potwierdzenie zawarcia umowy zostanie przesłane Klientowi na adres e-mail podany w formularzu zamówienia.</li>
            <li>W zależności od przedmiotu zamówienia, między Klientem a Dietetykiem może zostać zawarta umowa określonego rodzaju:</li>
            <ul>
        ...
        <h4>§5</h4>
        <h4>Konsultacje dietetyczne</h4>
        <ol>
            <li>
                Na stronie www.zdrowy-sukces.pl, Klient ma możliwość wybrania wariantu współpracy dietetycznej:
                <ul>
                    <li>
                        Online
                        <ol>
            ...
            <li>Dietetyk posiada odpowiednie kwalifikacje do udzielania świadczeń zdrowotnych oraz posiada kwalifikacje do udzielania świadczeń zdrowotnych w dziedzinie medycyny.</li>
            <li>Klient jest świadomy, że usługi świadczone przez Dietetyka nie dają gwarancji uzyskania założonych i oczekiwanych przez Klienta skutków.</li>
            <li>Dietetyk nie ponosi odpowiedzialności za wszystkie skutki wynikające z nieodpowiedniego stosowania planu żywieniowego i suplementacji przygotowanej przez Dietetyka. Klient jest świadomy, że niestosowanie się przez niego lub wybiórcze stosowanie się do uzyskanych zaleceń może przynieść negatywny skutek pod kątem stanu zdrowia, a nawet życia.</li>
            <li>Klient jest również świadomy, że zatajanie informacji bądź podanie nieprawdziwych informacji na temat swojego stanu zdrowia, stylu życia, przyjmowanych leków czy suplementów może negatywnie wpłynąć na stan zdrowia. Dietetyk nie ponosi za to odpowiedzialności.</li>
            <li>Ryzyko wystąpienia efektów ubocznych jest znikome, jednak Dietetyk nie jest w stanie przewidzieć wszystkich możliwych przeciwwskazań przy stosowaniu danej suplementacji i sposobu żywienia, dlatego Dietetyk nie bierze odpowiedzialności za negatywne skutki ich stosowania.</li>
            <li>Wszystkie informacje, które Dietetyk uzyskuje w trakcie świadczenia Usług dla Klienta, objęte są tajemnicą bezterminowo i nie są przekazywane osobom trzecim</li>
            <li>Warunkiem przystąpienia do współpracy z Dietetyka jest zaakceptowanie Regulaminu.</li>
        </ol>
        <h4>§6</h4>
        ...
        <ol>
            <li>Realizacja zamówienia obejmującego produkt elektroniczny taki jak jadłospis online itp. następuje poprzez przesłanie na adres e-mail podany przez Klienta w formularzu zamówienia wiadomości zawierającej instrukcję pobrania lub uzyskania dostępu do zakupionego produktu elektronicznego.</li>
            <li>Z chwilą wysyłki wiadomości, o której mowa w ust. 1 powyżej, treści cyfrowe objęte przedmiotem zamówienia uważa się za dostarczone w całości Klientowi.</li>
            <li>W odniesieniu do jadłospisów online i innych produktów elektronicznych nie przysługuje prawo do odstąpienia od umowy oraz zwrotu produktu zgodnie z postanowieniami §8.</li>
        </ol>
        <h4>§8</h4>
        <h4>Prawa własności intelektualnej</h4>
        <ol>
            ...
            <li>Prawa autorskie majątkowe i osobiste co do produktów i treści dystrybuowanych za pomocą Serwisu należą do Dietetyka.</li>
            <li>Bezprawne rozpowszechnianie treści lub materiałów, o których mowa w ust. 1 powyżej, może skutkować odpowiedzialnością cywilną lub karną.</li>
        </ol>
        <h4>§9</h4>
        <h4>Odstąpienie od umowy Konsumenta</h4>
        <ol>
            <li>Konsument, który zawarł ze Dietetykiem umowę na odległość, ma prawo odstąpić od umowy bez podawania przyczyny w terminie 14 dni od dnia zawarcia umowy (w przypadku umowy o dostarczenie treści cyfrowych).</li>
            <li>Prawo do odstąpienia od umowy nie przysługuje w odniesieniu do umów o dostarczanie treści cyfrowych, które nie są zapisane na nośniku materialnym, jeżeli spełnianie świadczenia rozpoczęło się za wyraźną zgodą Konsumenta przed upływem terminu do odstąpienia od umowy i po poinformowaniu go przez Dietetyka o utracie prawa odstąpienia od umowy.</li>
            <li>Prawo do odstąpienia od umowy nie przysługuje również, w odniesieniu do produktów przygotowywanych na specjalne zamówienie Konsumenta oraz według osobistych preferencji.</li>
            <li>Chwilą rozpoczęcia świadczenia jest doręczenie Klientowi wiadomości e-mail z instrukcją uzyskania dostępu do treści cyfrowych.</li>
            <li>Aby odstąpić od umowy, Konsument musi poinformować Dietetyka o swojej decyzji o odstąpieniu od umowy w drodze jednoznacznego oświadczenia - na przykład pismo wysłane pocztą, faksem lub pocztą elektroniczną.</li>
        ...
        <h4>§10</h4>
        <h4>Odpowiedzialność za wady</h4>
        <ol>
            <li>Dietetyk ma obowiązek dostarczyć Klientowi treść cyfrową wolną od wad.</li>
            <li>Dietetyk jest odpowiedzialny względem Klienta, jeżeli sprzedana treść cyfrowa ma wadę fizyczną lub prawną (rękojmia za wady).</li>
            <li>Jeśli Klient stwierdzi wadę treści cyfrowej, powinien poinformować o tym Dietetyka, określając jednocześnie swoje roszczenie związane ze stwierdzoną wadą lub składając oświadczenie stosownej treści.</li>
            <li>Klient może kontaktować się ze Dietetykiem zarówno pocztą tradycyjną, jak również pocztą elektroniczną.</li>
            <li> Dietetyk ustosunkuje się do składanej przez Klienta reklamacji w ciągu 14 dni od dnia doręczenia mu reklamacji za pomocą takiego środka komunikacji, przy wykorzystaniu którego reklamacja została złożona.</li>
            <li>Dietetyk nie ponosi odpowiedzialności za konsekwencje związane z podaniem przez Klienta niepełnych błędnych informacji o stanie zdrowia, zatajenia istotnych faktów, bądź nieprzedstawienia wszystkich wymaganych dokumentów, a także wyników badań czy też niestosowanie zaleceń podczas konsultacji dietetycznej.</li>
            <li>Konsultacja dietetyczna nie stanowi udzielenia pomocy, porady lub opinii lekarskiej, ani orzeczenia o stanie zdrowia w rozumieniu Ustawy o Zawodzie Lekarza. Konsultacja dietetyczna nie stanowi także działalności leczniczej ani świadczenia zdrowotnego w rozumieniu art. 3 ust. 1 Ustawy o Działalności Leczniczej. Konsultacja dietetyczna ma charakter informacyjny i edukacyjny oraz ma na celu promocję zdrowego stylu życia.</li>
            <li> Konsultacja dietetyczna nie zastępuje bezpośredniej wizyty u lekarza.  Jeżeli istnieją wątpliwości co do stanu zdrowia oraz ewentualnych przeciwwskazań do stosowania zaleceń dietetyka, na którymkolwiek z etapów należy zasięgnąć opinii lekarza. Zaleca się, aby przed przystąpieniem do jakiejkolwiek aktywności ruchowej oraz przed zastosowaniem jakiegokolwiek programu dietetycznego, zasięgnąć porady lekarza. Dieta i suplementacja mają na celu procesu leczniczego czy też zdrowego trybu życia, nie mogą zastąpić Klientowi konsultacji u lekarza specjalisty czy leków.</li>
        </ol>
        <h4>§11</h4>
        <h4>Dane osobowe i pliki cookies</h4>
        <ol>
            <li> Administratorem danych osobowych Klienta jest Dietetyk.</li>
            <li>Dane osobowe Klienta przetwarzane są w celu obsługi zamówień, konta użytkownika oraz ewentualnej obrony, dochodzenia lub ustalenia roszczeń związanych z zawieranymi za pośrednictwem Sklepu umowami.</li>
            <li>Szczegóły dotyczące przetwarzania danych osobowych oraz wykorzystywania plików cookies znajdują się w polityce prywatności dostępnej pod adresem www.zdrowy-sukces.pl</li>
        </ol>
        <h4>§12</h4>
        <h4>Pozasądowe sposoby rozpatrywania reklamacji i dochodzenia roszczeń</h4>
        <ol>
        ...
        <ol>
            ...
            <li> Niniejszy Regulamin obowiązuje od dnia 06.01.2022.</li>
        </ol>
    </section>
}